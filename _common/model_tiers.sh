...
ALL_MODELS=(
    ...
    # model_size_mb = footprint REAL la load (weights + activations + workspace),
    # nu doar marimea fisierului pe disc. Calibrat din vram_peak observat la runs
    # istorice pe ctx=32K (scazand KV cache stiut).
    "Modelfile-r1-14b  |mss-r1-14b  |deepseek-r1:14b                     |12000         |96            |10"
    "Modelfile-32b-q3  |mss-32b-q3  |qwen2.5:32b-instruct-q3_K_S         |17000         |128           |15"
    "Modelfile-14b     |mss-14b     |qwen2.5:14b-instruct-q8_0           |18000         |96            |16"
    "Modelfile-32b-q4  |mss-32b-q4  |qwen2.5:32b-instruct-q4_K_M         |17500         |128           |19"
    "Modelfile-r1-32b  |mss-r1-32b  |deepseek-r1:32b                     |17500         |128           |19"
    "Modelfile-qwq-32b |mss-qwq-32b |qwq:32b                             |17500         |128           |19"
)
